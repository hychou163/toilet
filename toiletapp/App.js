...
import Toilet from './app/page/toilet';
import Read from './app/page/read';
import Weather from './app/page/weather';
        ...
        return (
            <TabBarIOS>
                <TabBarIOS.Item
                    ...
                    {this._renderContent('#414A8C', 'toilet')}
                </TabBarIOS.Item>
                <TabBarIOS.Item
                    title="阅读"
                    ...
                    {this._renderContent('#783E33', 'read', this.state.notifCount)}
                </TabBarIOS.Item>
                <TabBarIOS.Item
                    title="天气"
                    ...
                    {this._renderContent('#21551C', 'weather', this.state.presses)}
                </TabBarIOS.Item>
                <TabBarIOS.Item
                    title="设置"
                    ...
                    {this._renderContent('#21551C', 'setting', this.state.presses)}
                </TabBarIOS.Item>
            </TabBarIOS>
        );
    }
